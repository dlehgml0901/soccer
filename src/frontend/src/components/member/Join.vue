        ...
        <form method="post">
            <div class="container">
                ...
                <div id='example-3'>
                    ...
                    <input type="checkbox" id="javascript" value="javascript" v-model="checkedNames">
                ...
                성별 :<br>
                <input type="radio" id="one" value="남성" v-model="gender">
                <label for="one">남성</label>
                <br>
                <input type="radio" id="two" value="여성" v-model="gender">
